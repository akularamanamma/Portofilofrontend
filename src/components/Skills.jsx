...
let skills=[{title:"FRONT END TECHNOLOGY PROFICIENCY",
  ...
  {title:"PROGRAMLING LANGUAGE",content:"I am proficient in Programing with JAVASCRIPT",
      ...
      <div className={style.skill_container}>
        {
         ...
         return <div key={i} className={ele.class}>
           ...
           <p style={{textAlign:'center',lineHeight:'30px',fontSize:'1.1rem'}}>{ele.content}</p>
         </div>
          })
        }
      </div>
